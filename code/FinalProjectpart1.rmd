...
getSymbols("^IXIC", from="1990-01-01")
returns  <- diff(log(Cl(IXIC)))
returns [as.character(head(index(Cl(IXIC)),1))] = 0
...
ArimaGarch <- ArimaGarch[index(ArimaGarch) >= '2007-01-01' & index(ArimaGarch) <= '2012-01-01']
```
