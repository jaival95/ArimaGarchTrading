...
getSymbols("BTC-USD", from="2012-01-01")
returns  <- diff(log(Cl(`BTC-USD`)))
returns [as.character(head(index(Cl(`BTC-USD`)),1))] = 0
...
ArimaGarch <- ArimaGarch[index(ArimaGarch) >= '2017-12-15'& index(ArimaGarch) <= '2018-04-01']
```
